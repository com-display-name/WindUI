...
local function getCurrentCamera()
    return workspace.CurrentCamera or cloneref(game:GetService("Workspace")).CurrentCamera
end
...
function DropdownMenu.New(Config, Dropdown, Element, CanCallback, Type)
    ...
    local function RecalculateListSize()
        ...
        local MaxHeight = ((camera and camera.ViewportSize.Y) or 0) * 0.6
    ...
    function UpdatePosition()
        ...
        local camera = getCurrentCamera()
        local viewportSizeY = camera and camera.ViewportSize.Y or 0
        
        local availableSpaceBelow = viewportSizeY - (button.AbsolutePosition.Y + button.AbsoluteSize.Y) - Element.MenuPadding - 54
