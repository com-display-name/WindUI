        ...
        if CanCallback then
            ...
            if not success then
                Config.WindUI:Notify({
                    Title = identifyexecutor and "Error" or "Can't use this.",
                    Content = (identifyexecutor and ("The " .. NewTitle .. " is not copied. Error: " .. result) or "This button doesn't work on non-exploit platforms."),
                    Icon = "x",
                    Duration = 5,
                })
            end
